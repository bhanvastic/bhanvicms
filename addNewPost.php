...
if(isset($_POST["Submit"])){
  ...
  //$Admin = $_SESSION["UserName"]; To use this I need to code Login.php
  $Admin = "Bhanvi";
  ...
  if(empty($PostTitle)){
    ...
    global $ConnectingDB;
    $sql = "INSERT INTO posts(datetime, title, category, author, image, post) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $ConnectingDB->prepare($sql);
    $stmt->bind_param('ssssss', $DateTime, $PostTitle, $Category, $Admin, $Image, $PostText);
